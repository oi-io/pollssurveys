...
public class PollssurveysApp {

    private static final Logger log = LoggerFactory.getLogger(PollssurveysApp.class);

    private final Environment env;

    public PollssurveysApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes pollssurveys.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PollssurveysApp.class);
